...
$(function () {
  var dataTablePermissions = $('.datatables-profiles'),
    dt_permission,
    userList = hdn_site_url+'permission';
  var hdn_site_url = $("#hdn_site_url").val();
  // Users List datatable
  if (dataTablePermissions.length) {
    dt_permission = dataTablePermissions.DataTable({
      ajax: hdn_site_url + 'User/permission_list', // JSON file to add data
      columns: [
  ...
  // Delete Record
  $('.datatables-profiles tbody').on('click', '.delete-record', function () {

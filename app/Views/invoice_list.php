...
>
  <head>
    ...
    <title>Invoice List - Pages | Digital - Bootstrap Admin Template</title>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>/public/assets/vendor/libs/datatables-bs5/datatables.bootstrap5.css" />
    <link rel="stylesheet" href="<?php echo base_url(); ?>/public/assets/vendor/libs/datatables-responsive-bs5/responsive.bootstrap5.css" />
    <link rel="stylesheet" href="<?php echo base_url(); ?>/public/assets/vendor/libs/datatables-buttons-bs5/buttons.bootstrap5.css" />
  ...
  <body>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold">Digital</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a
                href="https://pixinvent.com/demo/Digital-html-bootstrap-admin-template/documentation/"
                target="_blank"
                class="menu-link"
              >
                      ...
                      <ul class="list-group list-group-flush">
                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="<?php echo base_url(); ?>/public/assets/img/avatars/1.png" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="<?php echo base_url(); ?>/public/assets/img/avatars/2.png" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="<?php echo base_url(); ?>/public/assets/img/avatars/9.png" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="<?php echo base_url(); ?>/public/assets/img/avatars/5.png" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="<?php echo base_url(); ?>/public/assets/img/avatars/6.png" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                            <div class="flex-grow-1">
    ...
    <script src="<?php echo base_url(); ?>/public/assets/vendor/libs/datatables-buttons/datatables-buttons.js"></script>
    <script src="<?php echo base_url(); ?>/public/assets/vendor/libs/datatables-buttons-bs5/buttons.bootstrap5.js"></script>

    <!-- Main JS -->
    <script src="<?php echo base_url(); ?>/public/assets/js/main.js"></script>

    <!-- Page JS -->
    <script src="<?php echo base_url(); ?>/public/assets/js/app-invoice-list.js"></script>
  </body>
</html>

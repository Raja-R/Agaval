...
>
  <head>
    ...
    <title>Add - Invoice | Digital - Bootstrap Admin Template</title>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>/public/assets/vendor/css/pages/app-invoice.css" />
    <!-- Helpers -->
                      ...
                      <div class="row m-sm-4 m-0">
                        <div class="col-md-7 mb-md-0 mb-4 ps-0">
                          <div class="d-flex svg-illustration mb-4 gap-2 align-items-center">
                            ...
                            <span class="app-brand-text fw-bold fs-4"> Digital </span>
                          </div>
...
Dear Queen Consolidated,
    ...
    <script src="<?php echo base_url(); ?>/public/assets/vendor/libs/jquery-repeater/jquery-repeater.js"></script>

    <!-- Main JS -->
    <script src="<?php echo base_url(); ?>/public/assets/js/main.js"></script>

    <!-- Page JS -->
    <script src="<?php echo base_url(); ?>/public/assets/js/offcanvas-send-invoice.js"></script>
    <script src="<?php echo base_url(); ?>/public/assets/js/app-invoice-add.js"></script>
  </body>
</html>

...
<link rel="stylesheet" href="<?php echo base_url(); ?>/public/assets/vendor/libs/fullcalendar/fullcalendar.css" />
...
<link rel="stylesheet" href="<?php echo base_url(); ?>/public/assets/vendor/libs/quill/editor.css" />
<link rel="stylesheet" href="<?php echo base_url(); ?>/public/assets/vendor/libs/formvalidation/dist/css/formValidation.min.css" />

<!-- Page CSS -->

<link rel="stylesheet" href="<?php echo base_url(); ?>/public/assets/vendor/css/pages/app-calendar.css" />
    ...
    <div class="layout-container">
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
                  ...
                  <div class="p-3">
                    ...
                    <div class="app-calendar-events-filter ms-3">
                      <div class="form-check form-check-danger mb-2">
                        <input class="form-check-input input-filter" type="checkbox" id="select-personal" data-value="Cancel" checked />
                        <label class="form-check-label" for="select-personal">Cancel</label>
                      </div>
                      <div class="form-check mb-2">
                        <input class="form-check-input input-filter" type="checkbox" id="select-business" data-value="Upcomming" checked />
                        <label class="form-check-label" for="select-business">Upcomming</label>
                      </div>
                      <div class="form-check form-check-warning mb-2">
                        <input class="form-check-input input-filter" type="checkbox" id="select-family" data-value="Rejected" checked />
                        <label class="form-check-label" for="select-family">Rejected</label>
                      </div>
                      <div class="form-check form-check-success mb-2">
                        <input class="form-check-input input-filter" type="checkbox" id="select-holiday" data-value="Completed" checked />
                        <label class="form-check-label" for="select-holiday">Completed</label>
                      </div>
                      <div class="form-check form-check-info">
                        <input class="form-check-input input-filter" type="checkbox" id="select-etc" data-value="Pending" checked />
                        <label class="form-check-label" for="select-etc">Pending</label>
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      <form class="event-form pt-0" id="eventForm" onsubmit="return false">
                        ...
                        <div class="mb-3">
                          ...
                          <select class="select2 select-event-label form-select" id="eventLabel" name="eventLabel">
                            <option data-label="primary" value="Upcomming" selected>Upcomming</option>
                            <option data-label="danger" value="Cancel">Cancel</option>
                            <option data-label="warning" value="Rejected">Rejected</option>
                            <option data-label="success" value="Completed">Completed</option>
                            <option data-label="info" value="Pending">Pending</option>
                          </select>
                        </div>
                        <div class="mb-3">
          ...
          <script src="<?php echo base_url(); ?>/public/assets/vendor/libs/fullcalendar/fullcalendar.js"></script>

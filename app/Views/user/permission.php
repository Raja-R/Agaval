    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content p-3 p-md-5">
        ...
        <div class="modal-body">
          ...
          <form id="addPermissionForm" class="row" action="<?php echo site_url(); ?>User/add_permission" method="POST">
            <div class="col-12 mb-3">
              <label class="form-label" for="permission_name">Permission Name</label>
              <input type="text" id="permission_name" name="permission_name" class="form-control" placeholder="Permission Name" autofocus />
            </div>
            <div class="col-12 mb-3">
              <label class="form-label" for="permission_desc">Permission Description</label>
              <input type="text" id="permission_desc" name="permission_desc" class="form-control" placeholder="Permission Description" autofocus />
            </div>

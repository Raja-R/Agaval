                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex justify-content-between align-items-end mt-1">
                        <div class="role-heading">
                          ...
                          <a href="<?php echo site_url(); ?>User/role_permission/<?php echo $value->id; ?>" class="role-edit-modal"><span>Edit Role</span></a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row h-100">
                    ...
                    <div class="col-sm-7">
                      <div class="card-body text-sm-end text-center ps-sm-0">
                        <a href="<?php echo site_url(); ?>User/role_permission" class="btn btn-primary mb-2 text-nowrap add-new-role">
                          Add New Role
                        </a>

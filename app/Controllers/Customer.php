...
class Customer extends BaseController
{
    ...
    public function customer_list()
    {
        ...
        $customer_list = $CustomerModel->get_customer_data('CUSTOMER');
    ...
    public function save_customer()
    {
        ...
        $rules = [
            ...
            "customer_email" => "is_unique[customer.email]|valid_email",
            "customer_mobile" => "is_unique[customer.mobile]",
        ];
        ...
        if (!$this->validate($rules, $messages)) {
            ...
            if ($this->request->getVar("hdn_customerid") == '') {
                ...
                session()->setFlashdata('success_msg', 'Customer has been added successfully');
            } else {
                $data['updated_by'] = $this->auth->user()->id;
                $data['updated_at'] = date('Y-m-d H:i:s');
                $CustomerModel->update_data($this->request->getVar("hdn_customerid"), $data);
                session()->setFlashdata('success_msg', 'Customer has been updated successfully');
            }
    ...
    public function delete_customer()
    {
        ...
        if ($customer_id == '') {
            ...
            session()->setFlashdata('success_msg', 'Customer has been deleted successfully');
        }
